...
from utils.loss_utils import l1_loss, ssim, compute_normal_loss
from gaussian_renderer import render, network_gui
import sys
from scene import Scene, GaussianModel, DeformModel, DeformEnvModel
from utils.general_utils import safe_state, calculate_eccentricities, safe_normalize, reflect 
import uuid
from tqdm import tqdm
import lpips
from utils.image_utils import psnr
from argparse import ArgumentParser, Namespace
from arguments_banana import ModelParams, PipelineParams, OptimizationParams
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        # Render
        render_pkg_re = render(viewpoint_cam, gaussians, pipe, background, d_xyz, d_rotation, d_scaling, d_reflvec, iteration, opt)
...
def training_report(tb_writer, iteration, Ll1, loss, l1_loss, elapsed, testing_iterations, scene: Scene, renderFunc,
                    renderArgs, deform, deform_env, opt, load2gpu_on_the_fly):
    if tb_writer:
